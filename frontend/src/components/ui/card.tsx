...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & VariantProps<typeof cardVariants>>(({ className, ...props }, ref) => <div ref={ref} className={cn(cardVariants(), className)} {...props} />)
